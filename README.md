...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dawn-flower-07ae
```

A live public deployment of this template is available at [https://dawn-flower-07ae.templates.workers.dev](https://dawn-flower-07ae.templates.workers.dev)
